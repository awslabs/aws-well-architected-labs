-- modified: 2022-03-31
-- query_id: network-firewall-idle
-- query_description: This query shows cost and usage of Network Firewall Endpoints which didn't receive significant traffic last month.  Resources returned by this query could be considered for deletion or rearchitecture for centralized deployment.
