...
-- query_columns: bill_payer_account_id,line_item_usage_account_id,month_line_item_usage_start_date,line_item_usage_type,line_item_operation,sum_line_item_usage_amount,sum_line_item_unblended_cost
