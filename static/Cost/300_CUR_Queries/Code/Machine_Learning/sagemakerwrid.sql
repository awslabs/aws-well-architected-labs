...
-- query_columns: bill_payer_account_id,line_item_usage_account_id,day_line_item_usage_start_date,line_item_resource_id,line_item_usage_type,sum_line_item_usage_amount,sum_line_item_unblended_cost
