...
-- query_columns: bill_payer_account_id,line_item_usage_account_id,month_line_item_usage_start_date,product_region,sum_line_item_unblended_cost,amortized_cost,ri_sp_trueup,ri_sp_upfront_fees
