...
1. [Create a logging account from the organizations master account](#logging_account)
2. [Create the bucket for CloudTrail logs](#create_bucket)
3. [Ensure cross account access is read-only](#cross_account)
4. [Turn on CloudTrail from the root account](#cloudtrail)
5. [Verification](#verification)
6. [Rate this Lab](#rate_lab)

<a name="logging_account"></a>
...
[![1 Star](../../common/Images/star.png)](https://wellarchitectedlabs.com/Security_100_Create_a_Data_Bunker_1star)
[![2 star](../../common/Images/star.png)](https://wellarchitectedlabs.com/Security_100_Create_a_Data_Bunker_2star)
[![3 star](../../common/Images/star.png)](https://wellarchitectedlabs.com/Security_100_Create_a_Data_Bunker_3star)
[![4 star](../../common/Images/star.png)](https://wellarchitectedlabs.com/Security_100_Create_a_Data_Bunker_4star)
[![5 star](../../common/Images/star.png)](https://wellarchitectedlabs.com/Security_100_Create_a_Data_Bunker_5star)
