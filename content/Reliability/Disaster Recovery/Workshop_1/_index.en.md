...
This module takes advantage of [AWS Backup](https://aws.amazon.com/backup/) to copy and restore our Amazon EC2 instance, Amazon RDS database and Amazon S3 bucket into the secondary region **N. California (us-west-1)**. 
