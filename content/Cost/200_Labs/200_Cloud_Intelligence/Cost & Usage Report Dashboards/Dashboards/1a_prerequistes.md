---
title: "Prerequisites: AWS CLI (Optional)"
...
### Install or Update the AWS CLI (only for command line deployment option)
CLI commands can be used to complete the dashboard setup. If you need to enable your AWS CLI, follow the steps below. If you use Cloud Formation these steps are optional.
...
{{< prev_next_button link_prev_url="./cost-usage-report-dashboards/" link_next_url="../1b_cur_setup" />}}
